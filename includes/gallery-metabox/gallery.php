...
*/
  ...
  function gallery_metabox_enqueue($hook) {
    if ( 'post.php' == $hook || 'post-new.php' == $hook ) {
      wp_enqueue_script('gallery-metabox', WP_PLUGIN_URL . '/wp-for-my-clients/includes/gallery-metabox/js/gallery-metabox.js', array('jquery', 'jquery-ui-sortable'));
      wp_enqueue_style('gallery-metabox', WP_PLUGIN_URL . '/wp-for-my-clients/includes/gallery-metabox/css/gallery-metabox.css');
    }
  }
