    ...
    $( function() {
        $.fn.dot_wpfmc = function( options ) {
            ...
            $( options.button ).click( function() {
                ...
                tb_show( 'Upload a logo', 'media-upload.php?referer=dot_wpfmc&type=image&TB_iframe=true&post_id=0', false );
        ...
        // Usage
        $( '.upload' ).dot_wpfmc(); // Use as default option.
    } );
} ( jQuery ) );